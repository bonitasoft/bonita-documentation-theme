...
// Do not lint vendor prod ready files (exclude *.min.js)
glob.jsToLint = Array.from(glob.js)
glob.jsToLint = glob.jsToLint.concat([`!${srcDir}/{helpers,js}/**/*.min.js`])
...
const lintJsTask = createTask({
  ...
  call: task.lintJs(glob.jsToLint),
})
